    ...
    <body>
        ...
        <script>
            ...
            function test_program(){
                ...
                getLatLng();
                /*インスタグラムAPIのことなんですけど、前のプロジェクトに使ったのは非公式のAPIなので指定するユーザー名で直近投稿を取ることができました。しかし今回のプロジェックは位置情報で投稿の情報を取るのでインスタグラムの公式APIしか使えません。このAPIのデベロッパー版は招待したユーザーの情報しか見れませんので今回の課題ができないと思います。
 */
